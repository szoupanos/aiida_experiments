...
n = session.query(djmodels.DbGroup.sa.id, djmodels.DbNode.sa.uuid, djmodels.DbNode.sa.node_type, djmodels.DbNode.sa.label,
				  djmodels.DbNode.sa.description, djmodels.DbNode.sa.ctime, djmodels.DbNode.sa.mtime,
				  djmodels.DbNode.sa.nodeversion, djmodels.DbNode.sa.public,
				  djmodels.DbNode.sa.attributes[(attr_name)]).filter(djmodels.DbGroup.sa.label == group_choice).join(
