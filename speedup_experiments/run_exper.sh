...
group_list=(
"20160903-021949" 
"materials_cod_Alvarez_3D_layered"
"materials_icsd_3D_not_in_cod_vdW_vcrelaxed_structures"
"materials_cod_3D_up_to_6species_40atoms_pseudoOK"
"20160223-135015"
"20160216-163305"
"20160223-203757"
"20160225-234037"
...
for group in ${group_list[@]}; do
	...
	for attr_choice in ${attr_list[@]}; do
		...
		sudo sh -c 'sync; service postgresql stop; echo 1 > /proc/sys/vm/drop_caches; service postgresql start'
		sleep 1
